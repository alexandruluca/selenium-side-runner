Arguments: 
  /usr/local/Cellar/node/11.7.0/bin/node /usr/local/Cellar/yarn/1.13.0/libexec/bin/yarn.js add babel-cli

PATH: 
  /Users/tourdedave/.rbenv/shims:/usr/local/opt/fzf/bin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/MacGPG2/bin
...
Trace: 
  SyntaxError: /Users/tourdedave/_dev/seleniumhq/selenium-ide/packages/code-export-utils/package.json: Unexpected token } in JSON at position 466
...
npm manifest: 
  {
    "name": "code-export-utils",
    "version": "0.1.0",
    "description": "Utils for Selenium IDE code export",
