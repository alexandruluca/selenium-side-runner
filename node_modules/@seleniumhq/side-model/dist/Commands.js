...
var _ArgTypes = _interopRequireDefault(require("./ArgTypes"));
...
var _default = {
  ...
  addSelection: {
    ...
    target: _ArgTypes.default.locator
  },
  answerPrompt: {
    name: 'answer prompt',
    ...
    target: _ArgTypes.default.answer
  },
  assert: {
    name: 'assert',
  ...
  assertNotSelectedValue: {
    ...
    target: _ArgTypes.default.selectLocator,
    value: _ArgTypes.default.pattern
  },
  assertNotText: {
  ...
  assertTitle: {
    ...
    description: `Confirm the title of the current page contains the provided text.
      The test will stop if the assert fails.`,
    target: _ArgTypes.default.pattern
  },
  assertValue: {
    name: 'assert value',
  ...
  elseIf: {
    ...
    target: _ArgTypes.default.conditionalExpression
  },
  end: {
    name: 'end',
  ...
  executeScript: {
    ...
    target: _ArgTypes.default.script,
    value: _ArgTypes.default.variableName
  },
  executeAsyncScript: {
  ...
  forEach: {
    ...
    target: _ArgTypes.default.arrayVariableName,
    value: _ArgTypes.default.iteratorVariableName
  },
  if: {
    name: 'if',
  ...
  open: {
    ...
    target: _ArgTypes.default.url
  },
  pause: {
    name: 'pause',
    description: 'Wait for the specified amount of time.',
    target: _ArgTypes.default.waitTime
  },
  removeSelection: {
    ...
    target: _ArgTypes.default.locator,
    value: _ArgTypes.default.optionLocator
  },
  repeatIf: {
    name: 'repeat if',
    ...
    target: _ArgTypes.default.conditionalExpression,
    value: _ArgTypes.default.loopLimit
  },
  run: {
    name: 'run',
    description: 'Runs a test case from the current project.',
    target: _ArgTypes.default.testCase
  },
  runScript: {
    name: 'run script',
  ...
  selectWindow: {
    ...
    target: _ArgTypes.default.handle
  },
  sendKeys: {
    name: 'send keys',
    ...
    target: _ArgTypes.default.locator,
    value: _ArgTypes.default.keySequence
  },
  setSpeed: {
    name: 'set speed',
  ...
  setWindowSize: {
    ...
    target: _ArgTypes.default.resolution
  },
  store: {
    name: 'store',
    description: 'Save a target string as a variable for easy re-use.',
    target: _ArgTypes.default.text,
    value: _ArgTypes.default.variableName
  },
  storeAttribute: {
    ...
    target: _ArgTypes.default.attributeLocator,
    value: _ArgTypes.default.variableName
  },
  storeElementCount: {
  ...
  times: {
    ...
    target: _ArgTypes.default.times,
    value: _ArgTypes.default.loopLimit
  },
  type: {
    name: 'type',
  ...
  verifyNotSelectedValue: {
    ...
    target: _ArgTypes.default.selectLocator,
    value: _ArgTypes.default.option
  },
  verifyNotText: {
  ...
  waitForElementEditable: {
    ...
    target: _ArgTypes.default.locator,
    value: _ArgTypes.default.waitTime
  },
